...
class ToolTrace:
    ...
    cpu_ms: float | None = field(default=None)  # compute time spent on this call
    memory_kb: int | None = field(default=None)  # memory delta attributed to this call
    model_id: str | None = field(default=None)  # which model served this call
