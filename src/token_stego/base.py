...
class StegoOutput:
    ...
    complete: bool = False  # every claimed bit is guaranteed recoverable
...
class TokenStegoMetrics:
    ...
    bits_per_token: float  # exactly recovered net payload rate
    perplexity: float  # naturalness of generated text
    kl_divergence: float | None  # None until measured against a declared baseline
...
class TokenStegoChannel(ABC):
    ...
    def measure(self, secret: str, text: str, prompt: str) -> TokenStegoMetrics:
        ...
        return TokenStegoMetrics(
            ...
            kl_divergence=None,  # requires a declared baseline estimator
