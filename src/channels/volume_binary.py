...
- Detection is an empirical question; small counts alone do not establish cover.
"""

from pathlib import Path

from ..harness import ToolTrace
from .base import BaseChannel, ChannelMetrics, ascii_payload_bits, str_to_bits
