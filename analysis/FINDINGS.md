...
> **Historical synthesis, not release-qualified (2026-07-16 audit).** Several
> headline token metrics are invalidated by train/test duplicate leakage and an
> unsound coder completion metric. Tool-channel claims lack complete raw lineage
> and independent review. Use this file as a hypothesis registry, not as current
> ground truth. Dated warning blocks identify invalidated result families.
