...
> **Historical, non-reproducible from a clean checkout (2026-07-16 audit).**
> Paths to ignored `findings/` and `.pi/` artifacts below are preserved as
> provenance text, but their targets are unavailable. No measurement in
> this report is release-qualified until regenerated with a current manifest,
> immutable raw copies, exact model and source revisions, and isolated review.
...
- Best broad comparison run of serious contenders: `findings/overnight_3b/20260407-024307/summary.md`
- Post-hardening default comparison: `findings/overnight_3b/20260407-032046/summary.md`
- Experimental preset smoke: `findings/overnight_3b/20260407-031027/summary.md`
- Secret-conditioned path codebook success run: `findings/overnight_3b/20260407-021122/summary.md`
- Secret-conditioned query codebook success run: `findings/overnight_3b/20260407-023611/summary.md`
- Final parser-variant validation for `path_table`: `findings/overnight_3b/20260407-033207/summary.md`
...
This was captured in the local spec: `../.pi/specs/overnight-3b-sweep.md`.
...
Representative runs:
- first single-candidate smoke: `20260407-000423`
- first all-candidates tiny smoke: `20260407-000654`
...
- first 6-char path-table probe: `20260407-001924`
- early fixed-table comparison: `20260407-003856`
- first larger mixed comparison: `20260407-011502`
...
- before parser hardening: `20260407-005024`
- after first parser fix: `20260407-005726`
- later parser-extension validations: `20260407-010853`, `20260407-033207`
...
Representative runs:
- secret-conditioned path codebook: `20260407-021122`
- secret-conditioned query codebook: `20260407-023611`
- experimental preset smoke: `20260407-031027`
