...
> **Historical, not release-qualified (2026-07-16 audit).** The arithmetic
> coder's former width-based completion test could claim bits that its decoder
> did not recover, and the cited theorems do not apply to this vanilla
> target-point implementation. The results below are preserved as provenance,
