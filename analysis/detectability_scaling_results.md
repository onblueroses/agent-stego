...
> **Historical, not release-qualified (2026-07-16 audit).** These observations
> predate the group-disjoint split and artifact-lineage requirements. Claims of
> proof or undetectability do not apply to the implemented target-point coder.
