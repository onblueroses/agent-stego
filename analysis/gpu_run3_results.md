...
> **Historical, not release-qualified (2026-07-16 audit).** The activation and
> output-detection metrics below predate group-disjoint evaluation and durable
> artifact manifests. The token coder's former completion counter was unsound,
> and the cited theorems do not apply to this vanilla target-point
> implementation. Treat every metric, “fundamental duality” interpretation, and
> defense implication below as an invalidated hypothesis pending regeneration.
