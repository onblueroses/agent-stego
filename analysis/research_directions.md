...
> **Historical planning note (2026-07-16 audit).** Statements marked answered or
> proved below may rely on invalidated metrics or mismatched theorem assumptions.
> Treat the items as candidate experiments, not settled results.
