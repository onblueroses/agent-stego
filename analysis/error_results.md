...
> **Historical, not release-qualified (2026-07-16 audit).** The observations
> below lack exact model/source lineage, recoverable raw artifacts, independent
> cover-utility controls, and isolated review. Every metric, viability statement,
> and reliability projection is an unvalidated baseline hypothesis.
