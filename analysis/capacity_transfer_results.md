...
>
> **Further invalidated 2026-07-16:** the superseding rerun also used a
> sample-index split over repeated prompt groups, and the old coder's width-based
> completion metric was unsound. Neither probe AUC nor bits/token below is a
> validated net-capacity result.
