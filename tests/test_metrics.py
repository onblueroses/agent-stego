...
from src.channels.base import ascii_payload_bits
from src.channels.ordering import INDEX_TO_TOOL, OrderingChannel
...
class TestOrderingChannelBER:
    ...
    def test_identical_strings_ber_zero(self):
        ...
        assert metrics.bits_per_second == 4.0
...
def test_ascii_payload_bits_rejects_negative_character_count():
    with pytest.raises(ValueError, match="non-negative"):
        ascii_payload_bits(-1)
